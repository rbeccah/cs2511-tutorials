...
public class Lecturer extends Person {
     ...
     * @precondition  payRate has to be in the valid format as a string contained in the PAY_RATES map
     * @postcondition sets the salary from the given pay rate string
     */
