...
public interface Character {
     ...
     * @param points
     */
    // * STEP 3: Delegates damage() to the concrete class 
     ...
     */
    // Interfaces can contain default methods when you want to implement a method that has the same implementation
    // across all classes
    // The classes that implement Character do not need to provide implementation for makeMove() unless
