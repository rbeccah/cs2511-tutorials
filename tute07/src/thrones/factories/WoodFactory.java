...
public class WoodFactory extends CharacterFactory {
    ...
    public int getIntDivisibleBy() {
        int random = getInt(getDimension());

        // Divide by n using floor division to get a whole number quotient
    ...
    public King createKing() {
        return new WoodKing(getIntDivisibleBy(), getIntDivisibleBy());
    }

    @Override
    public Queen createQueen() {
        return new WoodQueen(getIntDivisibleBy(), getIntDivisibleBy());
    }

    @Override
    public Knight createKnight() {
        return new WoodKnight(getIntDivisibleBy(), getIntDivisibleBy());
    }

    @Override
    public Dragon createDragon() {
        return new WoodDragon(getIntDivisibleBy(), getIntDivisibleBy());
    }
