...
public class TrainBuilder {
    ...
    public TrainBuilder addPassengerWagon() {
        if (wagonPowerSoFar - PassengerWagon.POWER_REQUIRED < 0) {
            throw new IllegalStateException("Power is not sufficient in the train");
        }
        wagonPowerSoFar -= PassengerWagon.POWER_REQUIRED;
    ...
    public TrainBuilder addCargoWagon() {
        ...
        wagonPowerSoFar -= CargoWagon.POWER_REQUIRED;
